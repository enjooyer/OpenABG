...
export type ChannelAgentToolFactory = (params: { cfg?: OpenABGConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenABGConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenABGConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenABGConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenABGConfig }) => boolean;
