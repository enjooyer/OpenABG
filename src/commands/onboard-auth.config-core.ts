...
export function applyZaiConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyOpenrouterConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyMoonshotProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyMoonshotConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyMoonshotConfigCn(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applySyntheticProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyXiaomiProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenABGConfig): OpenABGConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyXaiProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyQianfanProviderConfig(cfg: OpenABGConfig): OpenABGConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenABGConfig): OpenABGConfig {
