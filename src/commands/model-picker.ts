...
function resolveConfiguredModelRaw(cfg: OpenABGConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenABGConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenABGConfig, model: string): OpenABGConfig {
...
export function applyModelAllowlist(cfg: OpenABGConfig, models: string[]): OpenABGConfig {
  const defaults = cfg.agents?.defaults;
