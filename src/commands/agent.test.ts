...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "openabg-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenABGConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenABGConfig["telegram"]>>,
