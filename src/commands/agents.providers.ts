...
function resolveDefaultAccountId(cfg: OpenABGConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenABGConfig): boolean {
...
export function summarizeBindings(cfg: OpenABGConfig, bindings: AgentBinding[]): string[] {
