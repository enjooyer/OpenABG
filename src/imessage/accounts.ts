...
export function listIMessageAccountIds(cfg: OpenABGConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpenABGConfig): string {
...
function mergeIMessageAccountConfig(cfg: OpenABGConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenABGConfig): ResolvedIMessageAccount[] {
