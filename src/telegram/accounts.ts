...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPENABG_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: OpenABGConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpenABGConfig): string {
...
function mergeTelegramAccountConfig(cfg: OpenABGConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: OpenABGConfig): ResolvedTelegramAccount[] {
