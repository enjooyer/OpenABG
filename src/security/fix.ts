...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OpenABGConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OpenABGConfig; env: NodeJS.ProcessEnv }): {
  cfg: OpenABGConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
