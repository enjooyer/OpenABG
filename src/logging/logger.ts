...
export const DEFAULT_LOG_DIR = "/tmp/openabg";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "openabg.log"); // legacy single-file path

const LOG_PREFIX = "openabg";
...
function resolveSettings(): ResolvedSettings {
  let cfg: OpenABGConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => OpenABGConfig;
      };
