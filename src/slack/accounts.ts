...
export function listSlackAccountIds(cfg: OpenABGConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpenABGConfig): string {
...
function mergeSlackAccountConfig(cfg: OpenABGConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenABGConfig): ResolvedSlackAccount[] {
