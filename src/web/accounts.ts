...
function listConfiguredAccountIds(cfg: OpenABGConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: OpenABGConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenABGConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenABGConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenABGConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenABGConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenABGConfig): ResolvedWhatsAppAccount[] {
