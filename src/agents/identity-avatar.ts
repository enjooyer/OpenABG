...
function resolveAvatarSource(cfg: OpenABGConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenABGConfig, agentId: string): AgentAvatarResolution {
