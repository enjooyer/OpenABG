...
function resolveWatchPaths(workspaceDir: string, config?: OpenABGConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenABGConfig }) {
