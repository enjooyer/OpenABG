...
describe("createOpenABGCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenABGCodingTools({
      config,
    ...
    const anthropicTools = createOpenABGCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenABGCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenABGCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
