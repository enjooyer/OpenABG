...
// pi-ai's built-in Anthropic catalog can lag behind OpenABG's defaults/docs.
...
export function buildModelAliasLines(cfg?: OpenABGConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveOpenABGAgentDir();
