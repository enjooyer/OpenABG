import type { OpenABGConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: OpenABGConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: OpenABGConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[openabg]";
}
