...
import type { GatewayBindMode, GatewayTailscaleMode, OpenABGConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.openabg.ai/gateway/tailscale", "https://docs.openabg.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
