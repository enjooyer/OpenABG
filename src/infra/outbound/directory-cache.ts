...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpenABGConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpenABGConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpenABGConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: OpenABGConfig): void {
