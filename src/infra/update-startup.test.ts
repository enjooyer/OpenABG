...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "openabg-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpenABGPackageRoot } = await import("./openabg-root.js");
    ...
    vi.mocked(resolveOpenABGPackageRoot).mockResolvedValue("/opt/openabg");
