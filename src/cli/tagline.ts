const DEFAULT_TAGLINE = "All your chats, one OpenABG.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Facilities Sieben is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a mimetic cluster: messy, delicious, effective.",
