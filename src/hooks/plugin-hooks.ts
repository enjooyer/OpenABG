...
import type { OpenABGPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenABGPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenABGPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
