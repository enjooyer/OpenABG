...
function resolveMentionPatterns(cfg: OpenABGConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenABGConfig | undefined, agentId?: string): RegExp[] {
