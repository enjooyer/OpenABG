...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openabg", { botUsername: "openabg" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openabg args", {
        botUsername: "openabg",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openabg" })).toBe(
      "/help@otherbot",
    );
  });
