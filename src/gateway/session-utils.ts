...
import { type OpenABGConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenABGConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenABGConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenABGConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenABGConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OpenABGConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OpenABGConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpenABGConfig): GatewaySessionsDefaults {
