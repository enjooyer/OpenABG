...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.OPENABG_STATE_DIR;
  const configPath = env.OPENABG_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    OPENABG_PROFILE: profile,
    OPENABG_STATE_DIR: stateDir,
    OPENABG_CONFIG_PATH: configPath,
    OPENABG_GATEWAY_PORT: String(port),
    OPENABG_GATEWAY_TOKEN: token,
    OPENABG_LAUNCHD_LABEL: resolvedLaunchdLabel,
    OPENABG_SYSTEMD_UNIT: systemdUnit,
    OPENABG_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    OPENABG_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    OPENABG_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    OPENABG_STATE_DIR: stateDir,
    OPENABG_CONFIG_PATH: configPath,
    OPENABG_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    OPENABG_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    OPENABG_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    OPENABG_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    OPENABG_LOG_PREFIX: "node",
    OPENABG_SERVICE_MARKER: NODE_SERVICE_MARKER,
    OPENABG_SERVICE_KIND: NODE_SERVICE_KIND,
    OPENABG_SERVICE_VERSION: VERSION,
  };
}
