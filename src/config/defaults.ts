...
function resolveAnthropicDefaultAuthMode(cfg: OpenABGConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyTalkApiKey(config: OpenABGConfig): OpenABGConfig {
...
export function applyModelDefaults(cfg: OpenABGConfig): OpenABGConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyLoggingDefaults(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyContextPruningDefaults(cfg: OpenABGConfig): OpenABGConfig {
...
export function applyCompactionDefaults(cfg: OpenABGConfig): OpenABGConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
