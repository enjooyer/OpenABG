...
export const A2UI_PATH = "/__openabg__/a2ui";

export const CANVAS_HOST_PATH = "/__openabg__/canvas";

export const CANVAS_WS_PATH = "/__openabg__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openabgCanvasA2UIAction.postMessage(...)
  // - Android: window.openabgCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openabgCanvasA2UIAction"];
  ...
  globalThis.OpenABG = globalThis.OpenABG ?? {};
  globalThis.OpenABG.postMessage = postToNode;
  globalThis.OpenABG.sendUserAction = sendUserAction;
  globalThis.openabgPostMessage = postToNode;
  globalThis.openabgSendUserAction = sendUserAction;
